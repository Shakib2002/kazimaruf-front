...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-whatsapp-foreground shadow-xl shadow-whatsapp/40 transition-transform hover:scale-110 sm:bottom-7 sm:right-7"
    >
      <span
        className="absolute inset-0 -z-10 animate-ping rounded-full bg-whatsapp opacity-40"
        aria-hidden
      />
